...
#####
 ...
 <table style="border:0;width:100%; color:ffffff; text-align:center;">
        ...
        <tr style="background:#505050">
           <td rowspan="2" style="width:40%"><img src="https://github.com/HIKARO-290/sales_system/blob/main/images%20for%20example/screens/sale_and_quotation.png?raw=true" width="30%"></td>
